...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CfP8Sh3_.mjs");
...
const manifest = {
  "8a81c8cf5b42026ee0eedaaec5fe44e869252b0a92af1aea2a8bf8b4f7faf35e": {
    functionName: "sendEmail_createServerFn_handler",
    importer: () => import("./send-email-5CP3xHwO.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Bj1YH3mG.mjs"),
    import("./start-U2cRoQEi.mjs"),
